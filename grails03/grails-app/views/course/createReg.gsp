	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="create" action="createStud" params="[courseId: registrationInstance.course.id]">
					<g:message code="default.create.label" args="['Student']" />
				</g:link></li>
			</ul>
		</div>
