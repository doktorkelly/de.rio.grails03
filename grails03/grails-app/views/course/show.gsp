	...
	<body>
		...
		<div id="show-course" class="content scaffold-show" role="main">
			...
			<ol class="property-list course">
				...
				<g:if test="${courseInstance?.group}">
				<li class="fieldcontain">
					<span id="group-label" class="property-label"><g:message code="course.group.label" default="Group" /></span>
					
						<span class="property-value" aria-labelledby="group-label"><g:fieldValue bean="${courseInstance}" field="group"/></span>
				...
				<g:if test="${courseInstance?.units}">
				<li class="fieldcontain">
					<span id="units-label" class="property-label"><g:message code="course.units.label" default="Units" /></span>
					
						<span class="property-value" aria-labelledby="units-label"><g:fieldValue bean="${courseInstance}" field="units"/></span>
				...
				<li class="fieldcontain">
					<span id="room-label" class="property-label"><g:message code="course.room.label" default="Room" /></span>
						...
						<span class="property-value" aria-labelledby="room-label"><g:link controller="room" action="show" id="${courseInstance?.room?.id}">${courseInstance?.room?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${courseInstance?.quartal}">
				<li class="fieldcontain">
					<span id="quartal-label" class="property-label"><g:message code="course.quartal.label" default="Quartal" /></span>
					
						<span class="property-value" aria-labelledby="quartal-label"><g:fieldValue bean="${courseInstance}" field="quartal"/></span>
