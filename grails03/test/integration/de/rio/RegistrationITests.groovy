...
class RegistrationITests {
    ...
    void testListByFilter() {
		...
		Registration r01 = new Registration(course: c01, student: s01).save(flush: true);
		Registration r02 = new Registration(course: c02, student: s02).save(flush: true);
		Registration r03 = new Registration(course: c03, student: s03).save(flush: true);
		
		//execute
		Map params = [courseName: 'c01', studentLastName: 's01', studentFirstName: 'f01', max: 10, offset: 0];
